			...
			<div class="category-list">
				<div id="parentVerticalTab">
					...
					<div class="resp-tabs-container hor_1">
						...
						<div>
							<div>
							<h3>MAISONS</h3> <a href="all-classifieds.php">View all Ads</a>
							<hr>
							...
							<div class="sub-categories">
								<ul>
									<li class="btn btn-info"><a href="real-estate.php">Appartements</a></li>
									<li class="btn btn-info"><a href="real-estate.php">Studios</a></li>
									<li class="btn btn-info"><a href="real-estate.php">Chambre</a></li>
								</ul>
							</div>
						</div>
						</div>
						...
						<div>
							<div>
							<div>
							<h3>VEHICULES</h3> <a href="all-classifieds.php">View all Ads</a>
							<hr>
							<figure class="category row">
							...
							<div class="sub-categories">
								<ul>
									<li class="btn btn-info"><a href="bikes.php">Motos</a></li>
									<li class="btn btn-info"><a href="cars.php">Camions</a></li>
									<li class="btn btn-info"><a href="cars-.php">Voitures</a></li>
					...
					<div>
						<div>
							<div>
							<h3>Terrains</h3> <a href="all-classifieds.php">View all Ads</a>
							<hr>
							<figure class="category row">
							...
							<div class="sub-categories">
								<ul>
									<li class="btn btn-info"><a href="bikes.php">Ventes</a></li>
									<li class="btn btn-info"><a href="cars.php">Locations</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div>
							<div>
							<h3>Salles</h3> <a href="all-classifieds.php">View all Ads</a>
							<hr>
							<figure class="category row">
							...
							<div class="sub-categories">
								<ul>
									<li class="btn btn-info"><a href="real-estate.php">Locations Complete</a></li>
									<li class="btn btn-info"><a href="real-estate.php">Decorations</a></li>
									<li class="btn btn-info"><a href="real-estate.php">Locations Simple</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div>
							<div>
							<h3>Chaises</h3> <a href="all-classifieds.php">View all Ads</a>
							<hr>
							<figure class="category row">
